        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
          ...
          <div class="flex gap-4">
            ...
            <button
              ...
              class="flex justify-center rounded-md bg-gray-200 px-3 py-1.5 text-sm/6 font-semibold text-gray-900 hover:bg-gray-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 dark:focus-visible:outline-gray-500"
            >
              Cancel
            </button>
          </div>
